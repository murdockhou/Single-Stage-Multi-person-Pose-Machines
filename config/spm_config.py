...
if spm_config['use_coco']:
    spm_config['train_json_file'] = '/home/hsw/hswData/multipose/coco_person_keypoints_train2017.json'
    spm_config['train_img_path'] = '/home/hsw/hswData/COCO2017/train2017'

    spm_config['test_json_file'] = '/home/hsw/hswData/multipose/coco_person_keypoints_val2017.json'
    spm_config['test_img_path'] = '/home/hsw/hswData/COCO2017/val2017'
else:
    spm_config['train_json_file'] = '/home/hsw/hswData/multipose/aitrain.json'
    spm_config['train_img_path'] = '/home/hsw/hswData/ai-challenger/ai_train/train'

    spm_config['test_json_file'] = '/home/hsw/hswData/multipose/aival.json'
